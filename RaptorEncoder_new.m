function [ SourceSymbols, RepairSymbols, numSouceSymbols, numPadding ] = RaptorEncoder_new( data, erasureRate, overhead )
% RAPTORENCODER  
% Input: data 
%        numOfRepairSymbols
...
numOfRepairSymbols = ceil((numSouceSymbols * erasureRate + overhead) / (1 - erasureRate));
